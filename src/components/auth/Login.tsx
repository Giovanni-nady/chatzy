...
console.log(colors);
  ...
  return (
    <View style={{backgroundColor:colors.primary}} className={`w-full h-full relative`}>
      <View className='w-full absolute top-0 start-0 end-0 h-1/4' />

      <View className='w-full bg-[#d3eddc] absolute top-1/4 bottom-0 p-5 rounded-t-[50px]'>
        <Text
        ...
        {!confirmation ? (
          <>
            <Text className='text-[#808080] text-lg mb-5'>
            ...
            <Button title={`current theme ${theme}`} onPress={toggleTheme} color={colors.primary} />
